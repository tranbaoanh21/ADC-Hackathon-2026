...
Vì vậy một ứng dụng hỗ trợ người khuyết tật nói chung chưa chắc đã đúng trọng tâm. Sản phẩm phải gắn với một tình huống công việc cụ thể, chẳng hạn theo dõi nội dung trong cuộc họp, đọc tài liệu nội bộ, hiểu yêu cầu từ quản lý, tham gia phỏng vấn hoặc thao tác với công cụ tại nơi làm việc.

Trang chính thức mô tả hành trình của một đội như sau: hiểu thách thức thực tế, phát triển giải pháp hòa nhập, kiểm thử ý tưởng và pitch trước giám khảo. AI được khuyến khích, đồng thời là một tiêu chí chấm riêng, nhưng phải được sử dụng hiệu quả, phù hợp và có trách nhiệm.

Thông tin chính thức: [ADC Hackathon 2026](https://industryhub.rmit.edu.vn/ADC/).

### Ba hướng giải pháp được chấp nhận
...
### Một ví dụ để phân biệt ý tưởng rộng và vấn đề đủ cụ thể
...
| Nội dung | Thông tin |
|---|---|
| Tên cuộc thi | RMIT Accessibility Design Competition — ADC Hackathon 2026 |
| Theme | AI & Employability |
| Format | Hackathon đổi mới sáng tạo trong 3 ngày |
| Ngày thi | 21–23/09/2026 |
...
## 3. Điều kiện tham gia và form đăng ký
...
Cả ba thành viên của team đều đang là sinh viên nên đáp ứng điều kiện cơ bản.
...
- thông tin mỗi người đang ở TP.HCM hay phải di chuyển từ nơi khác;
- nhu cầu hỗ trợ tại sự kiện, nếu có;
- hai nhóm khuyết tật team muốn ưu tiên;
- câu trả lời cho hai câu Motivation.

Form chính thức: [ADC Hackathon 2026 Registration](https://industryhub.rmit.edu.vn/ADC/register/).
...
> Select 2 areas your team would prefer to focus on. The organising team will review your preferences and confirm the final assignment before the event.
...
## 4. Timeline của cuộc thi

| Ngày | Sự kiện | Việc team cần chú ý |
|---|---|---|
| 13/09 | Hạn đăng ký | Nên đặt deadline nội bộ sớm hơn 1–2 ngày |
| 16/09 | Hạn cuối nhận thông báo shortlist | Kiểm tra email Team Lead và spam folder |
| 19/09 | Briefing online | Chốt rule, format bài nộp và assignment |
| 21/09 | Day 1 — Learn & Frame | Nhận brief và chọn problem |
| 22/09 | Day 2 — Test & Refine | Gặp end-users, mentors và technical consultants |
| 23/09 | Day 3 — Evaluate & Pitch | Nộp deck, video và thi Top 8 Finale |

Website chưa nêu giờ đóng form. Team không nên chờ tới tối 13/09 mới nộp.
...
- công bố competition brief;
- workshop về Accessibility và Universal Design;
- workshop From Idea to Prototype with AI Tools;
- workshop Design Thinking: From User Needs to Better Solutions.

Buổi chiều là teamwork time.

Điều quan trọng nhất trong Day 1 không phải viết được bao nhiêu code. Đến cuối ngày, team cần thống nhất được:

- người dùng cụ thể;
- một tình huống tại nơi làm việc;
- rào cản cần giải quyết;
- giả định nào đã có evidence và giả định nào phải hỏi;
- solution statement trong một câu;
- một luồng demo đủ nhỏ để hoàn thành;
- AI sẽ làm chính xác nhiệm vụ gì.
...
- Trong tình huống này, bước nào khó nhất?
- Hiện tại anh/chị giải quyết bằng cách nào?
- Cách hiện tại gây tốn thời gian hoặc mất context ở đâu?
- Output dạng text, audio hay từng bước sẽ hữu ích hơn?
- Nếu AI trả lời sai thì hậu quả có đáng kể không?
- Anh/chị muốn kiểm soát hoặc xác nhận bước nào?
...
- chỉnh deck;
- luyện pitch và Q&A;
- kiểm tra link, permission và bản dự phòng.

Thêm một tính năng mới sát giờ nộp hiếm khi đáng giá bằng một demo ổn định.
...
1. Một người dùng và một workplace moment.
2. Rào cản cụ thể và hậu quả.
3. Evidence từ end-user hoặc mentor.
4. Existing solution đang thiếu gì.
5. Solution của team trong một câu.
6. Luồng hoạt động.
7. Prototype demo.
8. AI làm nhiệm vụ gì và vì sao cần AI.
9. Các quyết định accessibility.
10. AI có thể sai ở đâu và team xử lý thế nào.
11. Feasibility, chi phí và roadmap.
12. Expected impact và closing.
...
- 40 giây: người dùng và vấn đề;
- 30 giây: evidence/existing gap;
- 20 giây: solution overview;
- 2–2,5 phút: demo;
...
### Cách ba người bổ trợ nhau

| Phần việc | Người lead | Người hỗ trợ |
|---|---|---|
| Problem framing và user research | Linh | Cả team |
| Scope và timeline | Linh | Anh, Phúc |
| Accessible frontend | Anh | Linh test flow |
| Backend và integration | Anh | Phúc |
| Model/API/prompt | Phúc | Anh |
| AI evaluation và safety | Phúc | Anh, Linh |
| Deploy và demo fallback | Anh | Phúc |
| Deck, video và pitch | Linh | Anh demo, Phúc giải thích AI |

---

## 9. Trong bốn nhóm đề bài, team nên chọn nhóm nào?

Form cho chọn hai nhóm. Để quyết định, team nên nhìn vào bốn yếu tố:

- nhóm có một workplace problem đủ cụ thể để tìm hiểu không;
- kỹ năng hiện tại có thể tạo prototype trong ba ngày không;
...
Không phải mọi người khiếm thị đều cần cùng một output. Có người cần screen-reader-friendly text, có người cần audio, có người muốn tóm tắt trước rồi mới mở chi tiết. Đây là phần phải hỏi end-user.
...
**Accessible Onboarding Document Converter**

Hệ thống nhận một tài liệu training/onboarding, trích xuất structure, OCR phần scan, thêm mô tả cho hình/chart và xuất accessible HTML. Scope nên giới hạn vào một loại tài liệu thay vì hứa chuyển đổi mọi PDF.
...
- AI bịa số liệu trong chart.
- OCR đọc sai.
- Mô tả bỏ qua context quan trọng.
- Tài liệu nội bộ chứa dữ liệu nhạy cảm.
- Latency quá cao nếu dùng trong live meeting.

Một thiết kế có trách nhiệm nên cho user xem uncertainty, kiểm tra data point và không lưu file nếu không cần.

#### Kết luận

**Đây là lựa chọn số một của team.** Nó tận dụng rõ nhất full-stack + multimodal AI, có cơ hội tạo demo mạnh và vẫn để Linh đóng vai trò quan trọng trong user research, workplace framing và impact.
...
**Structured Work Instruction Assistant**
...
Người dùng phải được review và sửa output. AI không nên tự suy diễn deadline rồi trình bày như sự thật.
...
- React/Next.js với layout ổn định và ít cognitive load.
- Node.js/Express hoặc Next.js server.
- LLM structured output và schema validation.
- RAG/vector search nếu brief liên quan đến knowledge base.
- User-controlled verbosity, step-by-step view và editable output.
- Source citation nếu AI lấy thông tin từ tài liệu nội bộ.
...
Sản phẩm không được chẩn đoán hoặc yêu cầu người dùng khai báo diagnosis. Mục tiêu là làm information/workflow rõ và dễ kiểm soát hơn.
...
- khó sử dụng chuột hoặc bàn phím thông thường;
- workstation không phù hợp;
- control vật lý khó thao tác;
...
| Nhóm | Khả năng tận dụng đội hình | Khả năng hoàn thành trong 3 ngày | Rủi ro chính | Xếp hạng |
|---|---|---|---|---:|
| Visual Impairment | Rất cao | Cao | Accuracy, screen-reader UX | 1 |
| Neurodivergence | Cao | Rất cao | Generic chatbot, stereotype | 2 |
| Deaf/Hard of Hearing | Khá | Khá | Speech/realtime chưa phải thế mạnh | 3 |
| Mobility Impairment | Trung bình-thấp | Thấp nếu cần hardware | Thiếu embedded/mechanical | 4 |

**Hai ô nên chọn trong form:**

- Visual Impairment.
- Neurodivergence.

Đây là quyết định dựa trên năng lực hiện tại, không có nghĩa team đã chốt solution. Sau khi BTC phân assignment và công bố brief, team vẫn phải bắt đầu lại từ user problem.
...
```json
{
  "goal": "Complete the monthly report",
  "definitionOfDone": [
    "Use the approved template",
    "Include revenue and retention data"
  ],
  "deadline": null,
  "ambiguities": ["The deadline is not specified"],
...
- AI trả JSON thiếu field;
- timeout hoặc API failure;
...
## 11. Công nghệ nên chuẩn bị trước
...
- học nền tảng Universal Design và accessibility;
- chuẩn bị bộ câu hỏi end-user;
- template competitor scan;
- assumption/decision log;
- deck skeleton chưa gắn với solution;
- cách chia việc quay video và luyện pitch.
...
- dữ liệu nào được gửi tới model;
- có lưu dữ liệu hay không;
- model thường sai ở trường hợp nào;
- user có thể kiểm tra và sửa output không;
- hệ thống làm gì khi không chắc chắn;
- nếu AI ngừng hoạt động thì user có fallback nào;
- chi phí và latency có phù hợp để triển khai thật không.
...
Hai đoạn dưới đây là bản nháp để cả team sửa lại bằng giọng của mình, không nên nộp nguyên văn nếu có chi tiết nào không đúng với động lực thật.

### Q1 — 100–120 words

> Our team wants to join ADC Hackathon 2026 because we believe technology creates meaningful value only when it enables more people to participate, contribute, and thrive at work. We bring complementary strengths in full-stack product engineering, applied AI research, and business strategy, project leadership, and communication. Together, we want to move beyond building technology for its own sake and learn how to design with people who experience accessibility barriers. ADC’s combination of end-user insight, Universal Design, AI prototyping, and industry mentorship gives us a rare opportunity to turn our skills into a responsible, practical, and accessible solution. We are ready to listen, challenge our assumptions, collaborate across disciplines, and build for genuine workplace impact.

Word count: 114.

### Q2 — 80–100 words

> We hope to learn how to translate real accessibility needs into focused product decisions rather than relying on assumptions. By working directly with end-users and mentors, we want to strengthen our understanding of Universal Design, responsible AI, rapid validation, and the practical constraints of inclusive workplaces. We also hope to improve how our three disciplines collaborate under pressure, from framing the problem and evaluating AI to building an accessible prototype and communicating its impact. Beyond the competition, we want to gain a repeatable process for creating technology with communities and the confidence to continue developing solutions that prove genuinely useful.
...
## 15. Giải thưởng và cơ hội nghề nghiệp
...
- Gift voucher 10.500.000 VND.
- Cash prize 6.000.000 VND.
- Ba voucher nghỉ dưỡng tại Emeralda Resort Ninh Bình.
- CV review/career consultation từ P&G.
- Fast-track tới HR interview tại Katalon theo điều kiện áp dụng.

### Hạng ba

- Gift voucher 7.500.000 VND.
- Ba voucher nghỉ dưỡng tại Emeralda Resort Ninh Bình.
- CV review/career consultation từ P&G.
- Fast-track tới HR interview tại Katalon theo điều kiện áp dụng.
...
Mỗi team nhận gift voucher trị giá 3.000.000 VND. Có năm giải khuyến khích.

Career opportunities và prizes chịu điều kiện riêng của BTC và đối tác.
...
## 17. Những câu cần hỏi tại briefing

1. Final assignment có chắc chắn nằm trong hai preference không?
2. Team được biết assignment vào thời điểm nào?
3. Brief có một challenge cố định hay nhiều challenge để chọn?
4. Generic starter repository được phép chuẩn bị tới mức nào?
5. Có được dùng external AI API, pretrained model và AI coding assistant không?
6. Có phải disclose model, dataset, API và license trong deck không?
7. Pitch deck có giới hạn số slide hoặc file format không?
8. Preliminary round có live demo hay chỉ xem deck/video?
9. Finale pitch và Q&A dài bao nhiêu phút?
10. Video được upload file hay gửi link? Giới hạn dung lượng là bao nhiêu?
11. Có yêu cầu nộp repository/source code không?
12. Trọng số từng judging criterion có được công bố không?
13. Internet, nguồn điện và không gian quay video tại địa điểm được hỗ trợ thế nào?
14. Team có được ghi âm hoặc tiếp tục liên hệ end-user sau session không?
...
- 7 Rings xây web platform dịch Vietnamese sign language và speech theo thời gian thực.
- InSight xây AI-powered app hỗ trợ visually impaired employees trong workplace interaction.
...
- [ADC 2025 — Designing a future for all](https://www.rmit.edu.vn/news/all-news/2025/oct/designing-a-future-for-all)
- [NeuroAICC case study](https://www.rmit.edu.vn/students/student-news-and-events/student-news/2025/neuroaicc-autistic-interview-accessibility-design-competition)
...
- Chốt Team Lead và team name.
- Chọn Visual Impairment và Neurodivergence.
- Ba người cùng sửa hai đoạn Motivation.
- Xác nhận thông tin cá nhân và eligibility.
- Nộp form trước deadline nội bộ, không chờ sát 13/09.

### Trước briefing

- Mỗi người đọc README này và ghi lại câu hỏi.
- Anh dựng một starter tối giản có accessibility components và mock AI mode.
- Phúc thử multimodal input và structured LLM output.
- Linh chuẩn bị interview/assumption templates.
- Cả team chạy một mini-hackathon 3–4 giờ.

### Sau khi biết assignment

- Tìm hiểu nhóm khuyết tật được phân công từ nguồn đáng tin.
- Xem existing assistive technologies và workplace workflow.
- Chuẩn bị câu hỏi cho end-users.
- Không chốt sản phẩm trước khi nhận brief.
- Chỉ chuẩn bị những technical capability có thể tái sử dụng.

### Trong cuộc thi

- Day 1: chốt problem và vertical slice.
- Day 2: dùng feedback để sửa solution và hoàn thành working flow.
- Day 3: freeze feature, hoàn thiện video/deck và luyện pitch.

---

## 20. Kết luận chung

Đội hình hiện tại mạnh nhất ở điểm kết hợp được ba phần thường bị tách rời trong hackathon: Phúc có thể đánh giá AI một cách nghiêm túc, Anh có thể biến nó thành sản phẩm chạy được, còn Linh giữ cho sản phẩm bám vào user problem và được trình bày thuyết phục.
...
1. [ADC Hackathon 2026 — Official Website](https://industryhub.rmit.edu.vn/ADC/)
2. [ADC Hackathon 2026 — Registration](https://industryhub.rmit.edu.vn/ADC/register/)
3. [RMIT ADC Facebook](https://www.facebook.com/rmit.adc)
4. [ADC 2025 — Designing a future for all](https://www.rmit.edu.vn/news/all-news/2025/oct/designing-a-future-for-all)
5. [NeuroAICC case study](https://www.rmit.edu.vn/students/student-news-and-events/student-news/2025/neuroaicc-autistic-interview-accessibility-design-competition)
